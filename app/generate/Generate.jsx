                        ...
                        {links.map((item, index)=>(
                            <div key={index} className='mx-5'>   
                                <input
                                    ...
                                    className='bg-[#F6F7F5] px-4 py-2 mx-2 my-2 focus:outline-blue-400 rounded-md '
                                    type='text'
                    ...
                    <div className='item'>
                        ...
                        <div className='mx-5 flex flex-col'>
                            ...
                            <button
                                ...
                                onClick={submitLinks}
                                className='disabled:bg-slate-500 px-5 py-2 mx-2 w-fit my-5 bg-[#c2d816] text-white font-bold rounded-full'
                            >
                                Create your Bittree
                            </button>
                        </div>
